...
export function Colored<BC extends Constructable<{}>>(Base: BC) {
  return class extends Base {
    static get props(): ComponentProps<any, ColoredProps> {
      return { color: prop.string<any, ColorType>({attribute: {source: true}}) };
    }
    color?: ColorType;
  };
}
...
export function Disabled<BC extends Constructable<{}>>(Base: BC) {
  return class extends Base {
    static get props(): ComponentProps<any, DisabledProps> {
      return { disabled: prop.boolean( {attribute: true} ) };
    }
    disabled?: boolean;
  };
}
